...
def start_encryption():
	...
	enc.encrypter()
	import subprocess
	outp = subprocess.Popen(". ~/venv1/bin/activate; python3 gdrive_upload.py",shell=True,stdout = subprocess.PIPE)
...
def start_decryption():
	import subprocess
	outp = subprocess.Popen(". ~/venv1/bin/activate; python3 download.py",shell=True,stdout = subprocess.PIPE)
	subproc_return = outp.stdout.read()
	out_str = str(subproc_return)
	print(out_str)
	dec.decrypter()
